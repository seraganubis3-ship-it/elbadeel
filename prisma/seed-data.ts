export const categories = [
  {
    name: 'الخدمات الشخصية والهوية',
    slug: 'identity',
    description: 'بطاقة رقم قومي، شهادة ميلاد، قسائم',
  },
...
export const services = [
  ...
  },
  {
    ...
    documents: [{ title: 'صورة بطاقة ولي الأمر' }, { title: 'شهادة تبليغ' }],
  },
  {
    category: 'identity',
    ...
    documents: [{ title: 'صورة بطاقة الزوجين' }],
  },
  {
    category: 'identity',
  ...
  },
  {
    ...
    documents: [{ title: 'صورة بطاقة المُبلّغ' }],
  },
  {
    category: 'family',
    ...
    documents: [{ title: 'صور بطاقات الأسرة' }],
  },
  {
    category: 'family',
    ...
    variants: [{ name: 'عادي', priceCents: 1200, etaDays: 3 }],
    documents: [{ title: 'صورة بطاقة' }],
  },
  {
    category: 'travel',
    ...
    documents: [{ title: 'صور شخصية' }, { title: 'شهادة ميلاد' }],
  },
  {
    category: 'travel',
