        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-blue-50/50 p-6 rounded-xl border border-blue-100 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-blue-900 mb-1">عنوان الـ SEO</label>
                <input
                  type="text"
                  name="seoTitle"
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 p-4 rounded-lg border">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">الكلمات الدلالية</label>
                  <input
                    type="text"
                    name="tags"
                    value={formData.tags}
