...
export default function OrderDetailClient({ order }: OrderDetailClientProps) {
  ...
  const sendWhatsAppMessage = () => {
    ...
    const message = `مرحباً ${currentOrder.customerName}،
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-3 space-x-reverse">
                    ...
                    >
                      <option value="PENDING" className="bg-white text-gray-900">في الانتظار</option>
                      <option value="IN_PROGRESS" className="bg-white text-gray-900">قيد التنفيذ</option>
                      <option value="COMPLETED" className="bg-white text-gray-900">مكتملة</option>
                      <option value="CANCELLED" className="bg-white text-gray-900">ملغية</option>
                    </select>
                    {isUpdating && (
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{(currentOrder.totalCents / 100).toFixed(2)} جنيه</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">المدة المتوقعة</p>
                  <p className="text-lg font-semibold text-gray-900">{currentOrder.variant.etaDays} يوم</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{currentOrder.customerName}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">رقم الهاتف</p>
                  <p className="text-lg font-semibold text-gray-900">{currentOrder.customerPhone}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">البريد الإلكتروني</p>
                  <p className="text-lg font-semibold text-gray-900">{currentOrder.customerEmail}</p>
                </div>
                    ...
                    <div key={doc.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{(doc.fileSize / 1024 / 1024).toFixed(2)} ميجابايت</p>
                        </div>
                      </div>
                      <a
                        href={doc.filePath}
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-2xl font-bold text-green-600">{(currentOrder.totalCents / 100).toFixed(2)} جنيه</span>
                </div>
              </div>
            </div>
