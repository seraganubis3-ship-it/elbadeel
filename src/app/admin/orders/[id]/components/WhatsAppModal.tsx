          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-3 sm:gap-4'>
              <div className='text-right'>
                <h3 className='text-white font-black text-lg sm:text-2xl tracking-tight'>إرسال واتساب</h3>
        ...
        <div className='p-5 sm:p-8 space-y-6 sm:space-y-8 overflow-y-auto custom-scrollbar flex-1'>
          ...
          <div>
            <div className='flex items-center justify-between mb-3 sm:mb-4'>
              ...
              <h4 className='text-xs sm:text-sm font-black text-slate-400 uppercase tracking-widest'>رسائل جاهزة</h4>
            </div>
            {loadingTemplates ? (
          ...
          <div>
            <div className='flex items-center justify-between mb-3 sm:mb-4'>
              <span className='text-[10px] sm:text-xs font-bold text-slate-300'>{message.length} حرف</span>
              <h4 className='text-xs sm:text-sm font-black text-slate-400 uppercase tracking-widest'>نص الرسالة</h4>
            </div>
            <textarea
              value={message}
              onChange={e => {
          ...
          <div className='bg-slate-900 rounded-2xl sm:rounded-[2rem] p-4 sm:p-6 text-white shadow-xl shadow-slate-200'>
            <div className='flex items-center justify-between gap-3'>
              ...
              <div className='text-left flex-1'>
                <p className='text-[10px] sm:text-xs font-black text-slate-500 uppercase tracking-widest mb-1'>رقم الهاتف المستهدف</p>
        ...
        <div className='p-5 sm:p-8 pt-0 flex flex-col sm:flex-row gap-3 sm:gap-4 shrink-0'>
          ...
          >
            {sending ? (
              ...
              <>
                <svg className='w-5 h-5 sm:w-6 sm:h-6 rotate-[-45deg]' fill='currentColor' viewBox='0 0 24 24'>
