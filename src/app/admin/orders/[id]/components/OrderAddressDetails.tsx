      ...
      <div className='flex items-center justify-between mb-8 pb-4 border-b border-slate-50'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-slate-500 text-sm font-medium'>مكان الإقامة والبيانات الجغرافية للتسليم</p>
          </div>
        </div>
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl transition-all font-bold text-sm ${
            isEditing ? 'bg-slate-100 text-slate-500 hover:bg-slate-200' : 'bg-cyan-50 text-cyan-600 hover:bg-cyan-100'
          }`}
        >
