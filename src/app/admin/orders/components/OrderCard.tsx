    ...
    >
      ...
      <div className='p-4'>
        ...
        <div className='flex gap-2'>
          ...
          {onPrintAuthorization && (
            <button
              onClick={() => onPrintAuthorization(order)}
              className='flex items-center justify-center gap-2 px-3 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-xl transition-colors text-sm font-medium'
              title='طباعة تفويض'
            >
              <svg className='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                <path
