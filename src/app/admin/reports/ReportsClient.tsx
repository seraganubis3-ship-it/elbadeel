...
export default function ReportsClient({ initialPeriod }: { initialPeriod: PeriodKey }) {
  ...
  return (
    <div className='space-y-8'>
      ...
      <div
        className='grid grid-cols-1 md:grid-cols-4 gap-6 opacity-100 transition-opacity'
            ...
            <div className='w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center'>
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d='M9 5h6m2 2H7a2 2 0 00-2 2v8a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2z'
                />
              </svg>
            </div>
          </div>
        ...
        <div className='bg-white rounded-xl shadow-lg p-6 border border-gray-100'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='mt-2 text-2xl font-bold text-gray-900'>
                {stats ? formatEGP(stats.revenueCents) : '—'}
              </p>
              <p className='text-xs text-gray-500'>
                الفترة السابقة: {stats ? formatEGP(stats.prevRevenueCents) : '—'}
              </p>
      ...
      <div className='bg-white rounded-xl shadow-lg p-6 border border-gray-100'>
        ...
        <div className='mt-3 text-xs text-gray-500 flex items-center gap-4'>
          <span className='inline-flex items-center gap-2'>
            <span className='w-3 h-3 rounded bg-green-500 inline-block' /> خط الإيرادات
          </span>
          <span className='inline-flex items-center gap-2'>
            <span className='w-3 h-3 rounded bg-blue-300 inline-block' /> أعمدة الطلبات
          </span>
        </div>
      </div>
      ...
      <div className='bg-white rounded-xl shadow-lg p-6 border border-gray-100'>
        ...
        <p className='text-gray-600 mb-4'>
          إجمالي النظام: {stats?.totalOrdersAll ?? '—'} طلب — الإيرادات الكلية:{' '}
          {stats ? formatEGP(stats.totalRevenueAllCents) : '—'}
        </p>
