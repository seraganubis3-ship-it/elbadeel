      ...
      <div className='flex items-center justify-between mb-8'>
        <div>
          ...
          <p className='text-gray-500 mt-2'>
            تحكم في جميع بيانات الموقع، العناوين، وأرقام التواصل من مكان واحد
          </p>
        </div>
          ...
          <div className='bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow duration-300'>
            ...
            <div className='p-6 space-y-6'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div>
                  <label className='block text-sm font-medium text-gray-700 mb-2'>
                    رقم الشكاوى والمقترحات
                  </label>
                  <input
                    type='text'
                    value={settings.complaintsPhone || ''}
                    onChange={e => setSettings({ ...settings, complaintsPhone: e.target.value })}
                    className='w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:outline-none transition-all'
                    dir='ltr'
                    placeholder='01001544258'
                  />
                </div>
                <div>
                  <label className='block text-sm font-medium text-gray-700 mb-2'>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setSettings({ ...settings, secondaryWhatsappPhone: e.target.value })
                    }
                    className='w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:outline-none transition-all'
                    dir='ltr'
        ...
        <div className='space-y-6'>
              ...
              <div>
                ...
                <div className='relative'>
                  <input
                    ...
                    onChange={e =>
                      setSettings({ ...settings, defaultDeliveryFee: parseFloat(e.target.value) })
                    }
                  ...
                  />
                  <span className='absolute left-4 top-3.5 text-gray-500 font-medium text-sm'>
                    ج.م
                  </span>
                </div>
              </div>
          ...
          <div className='bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow duration-300'>
            ...
            <div className='p-6 space-y-4'>
              ...
              {/* TikTok */}
              <div className='relative'>
                <span className='absolute right-4 top-3.5 text-black'>
                  <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
                ...
                <input
                  ...
                  className='w-full pr-12 pl-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-900/20 focus:border-gray-900 focus:outline-none transition-all'
              ...
              {/* Twitter */}
              <div className='relative'>
                <span className='absolute right-4 top-3.5 text-blue-400'>
                  <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
                ...
                <input
                  ...
                  className='w-full pr-12 pl-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-400/20 focus:border-blue-400 focus:outline-none transition-all'
              ...
              {/* LinkedIn */}
              <div className='relative'>
                <span className='absolute right-4 top-3.5 text-blue-700'>
                  <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
                ...
                <input
                  ...
                  className='w-full pr-12 pl-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-700/20 focus:border-blue-700 focus:outline-none transition-all'
