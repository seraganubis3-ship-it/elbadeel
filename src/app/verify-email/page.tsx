        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              {token ? "تأكيد البريد الإلكتروني" : 
               isVerifyingExisting ? "تفعيل الحساب الموجود" : "إعادة إرسال رسالة التأكيد"}
            </h1>
...
export default function VerifyEmailPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-white">...</div>}>
      <VerifyEmailInner />
    </Suspense>
  );
}
