...
export async function GET(request: NextRequest) {
  try {
    ...
    const revenueGrowth = (yesterdayRevenue._sum.totalPrice || 0) > 0
      ? (((todayRevenue._sum.totalPrice || 0) - (yesterdayRevenue._sum.totalPrice || 0)) / (yesterdayRevenue._sum.totalPrice || 0)) * 100
      : 0;
