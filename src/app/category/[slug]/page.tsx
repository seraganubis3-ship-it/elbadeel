        ...
        {category.services.length > 0 ? (
            ...
            {category.services.map((service) => (
              <div key={service.id} className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  {service.description && (
                    <p className="text-gray-600 mb-4 sm:mb-6 line-clamp-3">
                      {service.description}
                    </p>
                  )}
                  ...
                  {service.variants.length > 0 && (
                    <div className="mb-4 sm:mb-6">
                      <h4 className="text-sm font-semibold text-gray-700 mb-2 sm:mb-3">أنواع الخدمة:</h4>
                      <div className="space-y-2">
                        {service.variants.map((variant) => (
                          <div key={variant.id} className="flex justify-between items-center bg-gray-50 rounded-lg p-3">
                  ...
                  {service.documents.length > 0 && (
                    <div className="mb-4 sm:mb-6">
                      <h4 className="text-sm font-semibold text-gray-700 mb-2 sm:mb-3">المتطلبات:</h4>
          ...
          <div className="text-center py-12 sm:py-16">
            ...
            <p className="text-gray-600 mb-6 sm:mb-8">
              لم يتم إضافة خدمات في هذه الفئة بعد
            </p>
            <Link 
              href="/services"
