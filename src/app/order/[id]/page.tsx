        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl border border-green-200 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-xl">
              ...
              <span className="font-bold text-yellow-600 text-lg">{(order.totalCents / 100).toFixed(2)} جنيه</span>
            </div>
            ...
            {order.deliveryFee && order.deliveryFee > 0 && (
              <div className="flex items-center justify-between p-4 bg-red-50 rounded-xl">
                ...
                <span className="font-bold text-red-600">{(order.deliveryFee / 100).toFixed(2)} جنيه</span>
              </div>
            )}
          </div>
        </div>
