            ...
            return (
              ...
              >
                <div className='flex items-center mb-3 sm:mb-4'>
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br ${testimonial.color} rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg ml-2 sm:ml-3`}
                  >
                    {testimonial.initial}
                  </div>
                  <div>
                ...
                <p className='text-gray-700 text-xs sm:text-sm sm:text-base leading-relaxed'>
                  &quot;{testimonial.text}&quot;
                </p>
