...
export default function PriceCalculator({
  ...
  return (
    <div className='bg-white rounded-2xl shadow-lg p-6 border border-gray-100'>
      ...
      <div className='bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 mb-6 border border-green-200'>
        <div className='flex items-center justify-between'>
          ...
          <div className='text-right'>
            <div className='text-2xl font-bold text-green-600'>{basePrice.toFixed(2)} جنيه</div>
      ...
      <div className='mb-6'>
        <div className='flex items-center justify-between p-4 bg-yellow-50 rounded-xl border border-yellow-200'>
          <div className='flex items-center space-x-3 space-x-reverse'>
            ...
            <div>
              <label
                htmlFor='urgent-service'
                className='font-medium text-yellow-900 text-sm cursor-pointer'
              >
                خدمة سريعة
              </label>
      ...
      {/* Action Button */}
      <button className='w-full mt-6 bg-gradient-to-r from-green-600 to-green-700 text-white py-3 px-6 rounded-xl font-semibold hover:from-green-700 hover:to-green-800 focus:ring-4 focus:ring-green-300 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl'>
